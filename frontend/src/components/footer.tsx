        ...
        <Row className="gy-4">
          <Col md={4}>
            <h4 className="fw-bold text-primary">
              <h1 className="text-success fw-bold">zynetics</h1>
            </h4>
            ...
            <Row>
              <Col>
                ...
                <ul className="list-unstyled">
                  ...
                  <li><a href="#" className="text-dark text-decoration-none">Our Solutions</a></li>
              ...
              <Col>
                ...
                <ul className="list-unstyled">
                  <li><a href="#" className="text-dark text-decoration-none">Dubai Partnership</a></li>
                  <li><a href="#" className="text-dark text-decoration-none">Indian Partnership</a></li>
                  <li><a href="#" className="text-dark text-decoration-none">Location Partnership</a></li>
                </ul>
              </Col>
            </Row>
          </Col>
          ...
          <Col md={4}>
            ...
            <ul className="list-unstyled">
              ...
              <li><a href="#" className="text-dark text-decoration-none">Refund Policy</a></li>
              <li><a href="#" className="text-dark text-decoration-none">Payment Terms</a></li>
            </ul>
            ...
            <div className="d-flex gap-2">
              ...
              <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/78/Google_Play_Store_badge_EN.svg/200px-Google_Play_Store_badge_EN.svg.png"
                alt="Google Play" className="img-fluid" width="120" />
            </div>
          </Col>
        </Row>
        <hr></hr>
        <div className="text-center mt-4">
          <a href="#" className="text-dark mx-2"><FaFacebookF size={20} /></a>
          <a href="#" className="text-dark mx-2"><FaXTwitter size={20} /></a>
          <a href="#" className="text-dark mx-2"><FaLinkedinIn size={20} /></a>
        </div>
